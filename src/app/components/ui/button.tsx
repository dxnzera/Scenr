    ...
    variants: {
      variant: {
        ...
        secondary:
          "button-soft",
        ghost:
          "text-muted-foreground hover:bg-accent/65 hover:text-foreground dark:hover:bg-accent/50",
